...
<img class='python docs-image' src='https://cdn.quantconnect.com/i/tu/set-break-point-2.gif' alt="Setting a breakpoint in the algorithm">
<img class='csharp docs-image' src='https://cdn.quantconnect.com/i/tu/set-breakpoint-c-sharp.gif' alt="Setting a breakpoint in the algorithm">
<? } else { ?>
<p>Click to the left of a line to add a breakpoint on that line.</p>
<img class='python docs-image' src='https://cdn.quantconnect.com/i/tu/research-environment-breakpoint.gif' alt="Setting a breakpoint in the research environment">
<img class='csharp docs-image' src='https://cdn.quantconnect.com/i/tu/research-environment-breakpoint-c.gif' alt="Setting a breakpoint in the research environment">
<? } ?>
